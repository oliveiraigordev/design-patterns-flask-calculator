...
class Calculator2:
    ...
    * Todos esses N números são multiplicados por 11
    e elevados à potência de 0.95
    * Por fim, é retirado o desvio padrão desses resultados
    e retornado o inverso desse valor (1/result)
    '''
    ...
    def __process_data(self, input_data: List[float]) -> float:
        first_process_result = [(num * 1) ** 0.95 for num in input_data]
