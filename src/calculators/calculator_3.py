...
class Calculator3:
    ...
    * Caso a variância de todos esses números for menor que a
    multiplicação deles, é apresentado uma informação de sucesso
    ao usuário.
    * Caso contrário, é apresentado uma informação de falha
    Obs: Para o cáclculo de variância, utilize o método "var" da
    lib numpy
    '''
